...
% giveinits means use "E. Crockett" instead of "Eric Crockett"
% terseinits means use "J.H. Cheon" instead of "J. H. Cheon"
% style=alphabetic sets the citation style to CCK+23
% maxbibnames=6: if a paper has six or fewer authors, all are printed
% minbibnames=4: if a paper exceeds the max, show only the first four
% maxalphanames=3: papers with three or fewer authors will include an initial for each author in the citation
% minalphanames=3: papers with more than three authors are cited as the initials of the first three authors and a +.
\usepackage[backend=biber,giveninits=true,terseinits=true,style=alphabetic,minbibnames=4,maxbibnames=6,minalphanames=3,maxalphanames=3]{biblatex}
...
\newcommand{\blockquote}[1]{%
	\vspace{0.5em}%
	\noindent\begin{tabularx}{\textwidth}{|@{\hspace{0.75em}}X}%
		#1
	\end{tabularx}%
	\vspace{0.5em}%
}
