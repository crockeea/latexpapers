...
\begin{itemize}
	...
	\item DotProduct requires $\mathcal{O}(\frac{\ell^2}{k}+\ell)$ ring operations, plus $\mathcal{O}(\beta(\ell+k))\approx \mathcal{O}(\frac{\ell^2}{k}+\ell)$ NTTs. The NTTs dominate, hence this step requires $\mathcal{O}((\frac{\ell^2}{k}+\ell)\cdot N\log N)$ arithmetic operations.
